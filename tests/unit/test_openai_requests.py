...
def test_compact_trimming_keeps_latest_side_effect_tool_pair_when_it_fits():
    call = {
        "type": "function_call",
        "name": "exec",
        "call_id": "call-pair",
...
def test_compact_trimming_omits_oversized_latest_non_side_effect_custom_tool_output():
    call = {
        "type": "custom_tool_call",
        "name": "read_file",
