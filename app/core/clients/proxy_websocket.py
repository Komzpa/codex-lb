    ...
    *,
    ...
    try:
        response = await websocket_connect(
            ...
            # the websockets library's default ping watchdog can otherwise
            # close a healthy upstream turn with a synthetic 1011 keepalive
            # timeout before those budgets are reached.
            ping_interval=None,
