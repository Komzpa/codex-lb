...
class QuotaPlannerSettings(Base):
    ...
    # security-work stack. The focused PR no longer enables the planner policy,
    # but dropping the persisted settings would make that live schema unsafe to
    # upgrade or roll forward.
