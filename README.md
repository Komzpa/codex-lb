...
Laptops that switch Wi-Fi, hotspots, or VPNs should also read the
[Docker network-switching guidance](https://soju06.github.io/codex-lb/deployment/docker/#switching-wi-fi-hotspots-or-vpns).
